...
export const PALETTE_CONFIG = {
  blue: {
    ...
    card: 'bg-bluecard',
    cardheading: 'text-bluecardheading',
    cardpara: 'text-bluecardpara',
    headline: 'text-blueheadline',
    ...
    secondary: 'bg-bluesecondary',
  },
  peach: {
    bg: 'bg-peachbg',
    text: 'text-peachheadline',
    card: 'bg-peachcard',
    cardheading: 'text-peachcardheading',
    cardpara: 'text-peachcardpara',
    headline: 'text-peachheadline',
    ...
    secondary: 'bg-peachsecondary',
  },
  mint: {
    bg: 'bg-mintbg',
    text: 'text-mintheadline',
    card: 'bg-mintcard',
    cardheading: 'text-mintheadline',
    cardpara: 'text-mintheadline',
    headline: 'text-mintheadline',
